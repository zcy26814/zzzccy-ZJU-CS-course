 ...
 This software is an exact simulation of the 3-rotor Wehrmacht (Heer
 and Luftwaffe) the 3-rotor Kriegsmarine M3 and the famous 4-rotor
 Kriegsmarine M4 model of the German Enigma cipher machine, as they
 were used during world war II from 1939 until 1945. You can select
 between the different models, choose different rotors or 'Walzen',
 ...
 The extensive 22 page help file (use F1) contains the manual, how
 the German military used the Enigma, all the technical details and
 the story of Enigma.
 ...
 * System requirements:
 ...
 - Also works with WINE or other Windows emulations on Linux and MAC
 - The manual is provided in pdf format. A free pdf reader is
   available at http://www.adobe.com

 * To install the program (always uninstall any previous version
   before installing a new one!

   Method 1: Open the archive file with Winzip or IZArc and use the
   Install button from the Zip program (recommended method).

   Method 2: Open the archive file with Winzip or IZArc and extract
   all files into a folder and Start 'SETUP.exe'.
 ...
 * Known Issues:
 ...
 + v7.0.6 Cleared bug lock-up when start selected on empty autotyping
 + v7.0.5 Cleared bug program halt when key pressed while setting ring
 + v7.0.4 Added moving rotors while letter key held down
 + v7.0.3 Minor graphical corrections plugs and foto gallery
 + v7.0.2 Minor graphical corrections covers and plugboard
 + v7.0.1 Cleared bug plugs not visually clearing in QWERTZ layout

   v7.0.0
 + Major graphical revision with different Enigma I, M3 and M4 layout
 + Visualisation of both numbers rotors and letters rotors
 + Revised plug board, different plug board layout for Wehrmacht and
   Kriegsmarine machines. Plug board order changeable
 + Plugs seperately visible on top view, according to plug setup
 + Authentic sound effects, recorded from the real Enigma machine
 + Photo gallery with new own images of Enigma machines
 + Help file revised and expanded
 + Sound coding optimized and cleared audio bug on rotor double-step
 + Autotyping function optimized
 ...
 BE USED WHEN AGREEING THESE CONDITIONS.
